...
function test.draw()
	...
	if debug.draw_penetration then
		local penetration_vector = md:penetration_vector(vec2.zero)
		love.graphics.line(obstacle.min.x+200, obstacle.min.y+200, user.min.x + 25, user.min.y + 25)
	end
end
